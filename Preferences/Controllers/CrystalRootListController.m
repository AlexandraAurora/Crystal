...
- (void)promptToRespring {
    UIAlertController* resetAlert = [UIAlertController alertControllerWithTitle:@"Crystal" message:@"This option requires a respring to apply. Do you want to respring now?" preferredStyle:UIAlertControllerStyleAlert];
...
- (void)promptToResetPreferences {
    UIAlertController* resetAlert = [UIAlertController alertControllerWithTitle:@"Crystal" message:@"Are you sure you want to reset your preferences?" preferredStyle:UIAlertControllerStyleAlert];
